...
function HomeClient() {
  ...
  console.log("Ws" + WS_BASE_URL);
    ...
    <div className="bg-zinc-900 relative w-full h-screen flex flex-col justify-center items-center">
      <h1 className="text-white absolute top-[1em] bg-zinc-800/50 text-3xl my-4 rounded-4xl backdrop-blur-xl" style={{padding : "10px" , paddingInline : "30px" }}>This is Only CI Not CD 😎 yatin</h1>
